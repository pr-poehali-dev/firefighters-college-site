...
const Index = () => {
  ...
  const courses = [
    {
      title: "Пожарная тактика",
      description: "Основы тушения пожаров и проведения аварийно-спасательных работ",
      duration: "144 часа",
      level: "Базовый"
    },
    {
      title: "Пожарная техника",
      description: "Изучение пожарных автомобилей, оборудования и инструментов",
      duration: "120 часов", 
      level: "Профессиональный"
    },
    {
      title: "Основы безопасности",
      description: "Правила техники безопасности при работе на пожаре",
      duration: "96 часов",
      level: "Обязательный"
    }
  ];
